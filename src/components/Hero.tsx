      ...
      <div className="relative mx-auto flex h-full max-w-7xl flex-col justify-center px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <button className="bg-black px-8 py-4 text-sm font-bold uppercase tracking-widest hover:bg-neutral-900 transition-colors">
              Xem sản phẩm
            </button>
            <button className="border-2 border-white px-8 py-4 text-sm font-bold uppercase tracking-widest hover:bg-white hover:text-black transition-all">
              Bộ sưu tập mới
            </button>
          </div>
        </motion.div>
